...
public class ReduceState
{
    ...
    public static class StatefulMap extends RichFlatMapFunction<Tuple2<Long, String>, Long>
    {
        ...
        private transient  org.apache.flink.api.common.state.ReducingState<Long> sum;
        ...
        public void open(Configuration conf)
        {
            ...
            ReducingStateDescriptor<Long> sumDesc = new ReducingStateDescriptor<Long>("sum", new SumReduce(), Long.class);
